...
| Combat_Directive | v0.1.0 | Docs/Combat_Directive_v0_1_0.md | Combat perspective, 7-lane stage, action commands, turn structure | Supplements GDD §18. Part 4 defense model superseded 2026-08-05 by full-avoidance Dodge/Parry (see DECISIONS.md -> [Combat]). Part 3 gained locked lane-occupancy/movement-cost-model rules 2026-08-11, feeding Attack_Pattern_Directive. |
| Attack_Pattern_Directive | v0.1.0 | Docs/Attack_Pattern_Directive_v0_1_0.md | Melee Beat Sequence framework (Approach/Windup/Attack), telegraph knobs, ranged/melee archetypes, Strike Points | 2026-08-11: Lane Movement, Telegraph Knob Schema, and Beat Sequence are now BUILT for one minimal example (`Melee_Slash`, `LaneMovementSystem.cs`, `BeatSequenceRunner.cs` — see CHANGELOG.md). Strike Points, ranged archetypes, and additional melee patterns (Parts 5/6/9) remain design-capture only, deliberately not built this pass. Diagram companion: Docs/melee_beat_sequence.mermaid. Open gap: Type E (Reaction) has no trigger point against melee sequences yet (see doc Part 10). |
